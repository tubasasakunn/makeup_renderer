...
class Options(object):
    ...
    make["Foundation"]["Params"]["RGB"]=[0.1,0.1,0.1]
    ...
    make["Lipstick"]["Params"]["RGB"]=[0.6,0.03,0.3]
    ...
    B=0.3
    RightEyeParams=[]
    RightEyeParams.append([[0.5],[0.33],[0.5],[0.67],[0.3],[0.5],[0.75],[R,G,B],[0.91]])
    RightEyeParams.append([[0.5],[0.33],[0.5],[0.67],[0.3],[0.5],[0.2],[R,G,B],[0.91]])
    RightEyeParams.append([[0.5],[0.33],[0.5],[0.67],[0.3],[0.3],[0.25],[R,G,B],[0.91]])
    ...
    LeftEyeParams=[]
    LeftEyeParams.append([[0.5],[0.33],[0.5],[0.67],[0.3],[0.5],[0.75],[R,G,B],[0.91]])
    LeftEyeParams.append([[0.5],[0.33],[0.5],[0.67],[0.3],[0.5],[0.2],[R,G,B],[0.91]])
    LeftEyeParams.append([[0.5],[0.33],[0.5],[0.67],[0.3],[0.3],[0.25],[R,G,B],[0.91]])
    ...
    MirrorHighLightParams=[]
    MirrorHighLightParams.append([[0.5],[0.1],[0.5],[0.2],[0.5],[0.15],[0.2],[0.9,0.9,0.9],[0.91]])   #ほっぺ
    MirrorHighLightParams.append([[0.38],[0.4],[0.4],[0.38],[0.4],[0.4],[0.2],[0.9,0.9,0.9],[0.91]])  #目頭
    ...
    HighLightParams=[]
    HighLightParams.append([[0.7],[0.5],[0.75],[0.5],[0.725],[0.5],[0.2],[0.9,0.9,0.9],[0.91]])    
    HighLightParams.append([[0.9],[0.5],[0.95],[0.5],[0.925],[0.5],[0.2],[0.9,0.9,0.9],[0.91]])     
    HighLightParams.append([[0.1],[0.2],[0.1],[0.8],[0.1],[0.5],[0.2],[0.9,0.9,0.9],[0.91]])        
    HighLightParams.append([[0.4],[0.5],[0.5],[0.5],[0.45],[0.5],[0.2],[0.9,0.9,0.9],[0.91]])
    HighLightParams.append([[0.5],[0.5],[0.6],[0.5],[0.55],[0.5],[0.2],[0.9,0.9,0.9],[0.91]])
